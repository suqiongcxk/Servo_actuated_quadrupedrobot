...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@通道定义@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
uint16_t			Left_thigh_channel   				    =					0x0202;     //左大腿舵机通道
uint16_t			Left_lower_leg_channel    		        =					0x0101;		//左小腿舵机通道
uint16_t			Left_hip_channel     	 	            =					0x0201;		//左髋舵机通道		
uint16_t			Right_thigh_channel     	 		    =					0x0103;		//右大腿舵机通道		
uint16_t			Right_lower_leg_channel   	 	        =					0x0102;		//右小腿舵机通道		
uint16_t			Right_hip_channel     			        =					0x0104;		//右髋舵机通道		
...
{  
    ...
    {
    //先初始化大腿跟髋关节的PWM通道
    MOVE_TARget[RIGHT_HIP_ID] = 180.0f;
    MOVE_TIME[RIGHT_HIP_ID]   = 5000;
    MOVE_TARget[LEFT_HIP_ID] = 1.0f;
