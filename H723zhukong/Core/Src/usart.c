...
volatile uint8_t Blute_tooth_flag = 0;
int8_t USART6_rx_dma_buffer[15]={0} ;
int8_t USART6_dma_buffer[15] ={0} ;
...
//#define PLATFORM_G4
#define PLATFORM_H723  // 新增H723平台选项
// ==================================
...
void MX_UART7_Init(void)
{
  ...
  // 启动 DMA 接收 SBUS
  HAL_UART_Receive_DMA(&huart7, sbus_buf, SBUS_FRAME_SIZE);
...
void MX_USART1_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART1_Init 2 */
		...
		HAL_UARTEx_ReceiveToIdle_DMA(&huart1,(uint8_t *)RS485_rx_dma_buffer,sizeof(RS485_rx_dma_buffer));
...
void MX_USART6_UART_Init(void)
{
  ...
  /* USER CODE BEGIN USART6_Init 2 */
		HAL_UARTEx_ReceiveToIdle_DMA(&huart6,(uint8_t *)USART6_rx_dma_buffer,sizeof(USART6_rx_dma_buffer));
...
void HAL_UARTEx_RxEventCallback(UART_HandleTypeDef *huart, uint16_t Size)
{
    ...
    if (huart==&huart1)//RS485
    {
        ...
        memset(RS485_rx_dma_buffer, 0, sizeof(RS485_rx_dma_buffer));       
			HAL_UARTEx_ReceiveToIdle_DMA(&huart1, RS485_rx_dma_buffer, sizeof(RS485_rx_dma_buffer));       
    }else if (huart==&huart6)
		
		{
				HAL_UART_DMAStop(&huart6); // 此时安全
			if(Blute_tooth_flag ==0)
			{
        memcpy(USART6_dma_buffer, USART6_rx_dma_buffer,Size);       

        Blute_tooth_flag = 1;       
			}
        memset(USART6_rx_dma_buffer, 0, sizeof(USART6_rx_dma_buffer));       

			HAL_UARTEx_ReceiveToIdle_DMA(&huart6, USART6_rx_dma_buffer, sizeof(USART6_rx_dma_buffer));		
		}
