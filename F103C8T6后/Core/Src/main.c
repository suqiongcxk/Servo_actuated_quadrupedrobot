...
int main(void)
{
  ...
  HAL_TIM_Base_Start(&htim4);
	...
	#if 0
C:\Users\CXK\Desktop\dog\12Srevo_slave_3_31\F103C8T6后\Core\Src\main.c
	while(1){
	...
	#endif  
	HAL_TIM_PWM_Start(&htim1,Right_hip_PWMchannel);  
  HAL_TIM_PWM_Start(&htim2,Left_hip_PWMchannel);
	HAL_Delay(1500);
	
  HAL_TIM_PWM_Start(&htim2,Left_thigh_PWMchannel);
